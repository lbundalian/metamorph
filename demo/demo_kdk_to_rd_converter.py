...
Usage:
    python demo_kdk_to_rd_converter.py <input_kdk_file> [output_rd_file]

Examples:
    python demo_kdk_to_rd_converter.py sample/KDK.json
    python demo_kdk_to_rd_converter.py sample/KDK.json output/transformed_rd.json
"""
...
# Add the src directory to the Python path for direct imports without package installation
